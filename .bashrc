...
if [ "$color_prompt" = yes ]; then
    if [ "$USER" = "root" ]; then
        PS1='${debian_chroot:+($debian_chroot)}\[\033[01;34m\][\D{%T}]\[\033[00m\] \[\033[01;31m\]\u@\h\[\033[00m\] \[\033[01;34m\]\w\[\033[00m\] \[\033[01;31m\]#\[\033[00m\] '
    else
        PS1='${debian_chroot:+($debian_chroot)}\[\033[01;34m\][\D{%T}]\[\033[00m\] \[\033[01;32m\]\u@\h\[\033[00m\] \[\033[01;34m\]\w\[\033[00m\] \[\033[01;32m\]\$\[\033[00m\] '
    fi
else
...
# Some MS Windows muscle-memory compartibility
alias cls='clear'
alias cd..='cd ..'
alias ping='ping -c 4'
